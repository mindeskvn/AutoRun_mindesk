...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        // Checkboxes Cấu hình
        const cfgAutoRun = document.getElementById('cfg-auto-run');
        ...
        const switchTab = (tabName) => {
            try {
                ...
                if (tabName === 'dashboard') {
                    ...
                    sectionDesc.textContent = 'Lịch sử tự động click và ghi nhận hoạt động từ IDE.';
        ...
        autorunToggle.addEventListener('change', () => {
            try {
                ...
                console.error("[Error in toggle_handler]: Loi gui yeu cau bat/tat Auto-Run. Chi tiet:", toggleErr.message);
            }
        });

        // Click vá cấu hình IDE
        btnPatchIde.addEventListener('click', () => {
            try {
                window.api.requestPatch();
            } catch (patchErr) {
                console.error("[Error in patch_btn_handler]: Loi gui yeu cau va IDE. Chi tiet:", patchErr.message);
            }
        });
        ...
        btnSaveConfig.addEventListener('click', () => {
            try {
                ...
                console.error("[Error in save_config_handler]: Loi gui cau hinh moi. Chi tiet:", saveErr.message);
            }
        });
