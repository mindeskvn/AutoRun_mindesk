@echo off
cd /d "%~dp0antigravity-auto-run-desktop"
...
echo [INFO] De build ban Mac, hay mang thu muc 'antigravity-auto-run-desktop' sang may Mac va chay lenh: npm run build:mac
